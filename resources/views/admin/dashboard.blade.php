...
<div class="grid gap-6 md:grid-cols-4 mt-1 mb-1 px-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        ...
        <ul class="text-sm space-y-2">
            <li>
                <a href="{{ route('admin.charts') }}" class="flex items-center gap-2 text-gray-600 hover:text-orange-600 transition-colors hover:underline">
...
<div class="mt-2 mb-0 flex items-center justify-end gap-4 mb-2 px-6">
    <a href="{{ route('admin.charts') }}" class="bg-blue-500 gap-2 text-white px-4 py-2 text-right rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
